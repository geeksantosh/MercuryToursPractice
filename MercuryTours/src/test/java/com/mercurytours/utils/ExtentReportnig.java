...
public class ExtentReportnig extends TestListenerAdapter{
	...
	public void onStart(ITestContext testContext)
	{
		...
		extent.setSystemInfo("Environemnt","Windows");
		extent.setSystemInfo("user","Santosh Adhikari");

		htmlReporter.config().setDocumentTitle("Murcury Tour Test Project"); // Tile of report
